...
class DatasetBase:
    ...
    def __init__(self, train_x=None, train_u=None, val=None, test=None):
        ...
        self._num_class_list = self.get_num_class_list(test)
        self._lab2cname_list, self._classname_list = self.get_lab2cname_list(test)
...
class BEIJING_Dataset(DatasetBase):

    dataset_dir = "beijing_dataset"
