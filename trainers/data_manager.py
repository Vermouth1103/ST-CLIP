...
from trainers.dataset_build import build_dataset
...
class DataManager:
    ...
    def __init__(
        ...
        # Attributes
        self._num_class_list = dataset.num_class_list
        self._lab2cname_list = dataset.lab2cname_list
    ...
    def show_dataset_summary(self, cfg):
        ...
        table.append(["# masks", f"{len(self.num_class_list):,}"])
        for index, item in enumerate(self.num_class_list):
            table.append([f"# class_{index}", f"{item}"])
...
class DatasetWrapper(TorchDataset):
    ...
    def __getitem__(self, idx):
        ...
        output = {
            ...
            "impath": item.impath,
            "index": idx,
            "traj_property": item.traj_property
        }
